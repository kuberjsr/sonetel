 ...
 * Original file: E:\\CVS\\SonetelRoot\\PBX\\AndroidClient\\src\\com\\sonetel\\api\\ISipService.aidl
 */
package com.sonetel.api;
public interface ISipService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.sonetel.api.ISipService
{
private static final java.lang.String DESCRIPTOR = "com.sonetel.api.ISipService";
...
/**
 * Cast an IBinder object into an com.sonetel.api.ISipService interface,
 * generating a proxy if needed.
 */
public static com.sonetel.api.ISipService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.sonetel.api.ISipService))) {
return ((com.sonetel.api.ISipService)iin);
}
return new com.sonetel.api.ISipService.Stub.Proxy(obj);
}
...
int _arg0;
_arg0 = data.readInt();
com.sonetel.api.SipProfileState _result = this.getSipProfileState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.sonetel.api.SipCallSession _result = this.getCallInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.sonetel.api.SipCallSession[] _result = this.getCalls();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.sonetel.api.SipCallSession _arg0;
if ((0!=data.readInt())) {
_arg0 = com.sonetel.api.SipCallSession.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.sonetel.api.MediaState _result = this.getCurrentMediaState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements com.sonetel.api.ISipService
{
...
/**
	...
	*/
public com.sonetel.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.sonetel.api.SipProfileState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(accountId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.sonetel.api.SipProfileState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public com.sonetel.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.sonetel.api.SipCallSession _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(callId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.sonetel.api.SipCallSession.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public com.sonetel.api.SipCallSession[] getCalls() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.sonetel.api.SipCallSession[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.sonetel.api.SipCallSession.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public void adjustVolume(com.sonetel.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public com.sonetel.api.MediaState getCurrentMediaState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.sonetel.api.MediaState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentMediaState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.sonetel.api.MediaState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
