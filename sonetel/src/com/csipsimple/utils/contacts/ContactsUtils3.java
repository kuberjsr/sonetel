...
public class ContactsUtils3 extends ContactsWrapper {
    ...
    private static final String SORT_ORDER = Contacts.Phones.DISPLAY_NAME + " ASC," + Contacts.Phones.TYPE;
	...
	public Cursor searchContact(Context ctxt, CharSequence constraint) {
        ...
        String selection = String.format("%s=%s OR %s=%s OR %s=%s",
                ...
                Phone.TYPE_MMS);
         */
        String selection = String.format("%s LIKE ? OR %s LIKE ?", Contacts.Phones.NUMBER, Contacts.Phones.DISPLAY_NAME);
        Cursor phoneCursor =
