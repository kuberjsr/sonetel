...
public class PreferencesWrapper {
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.SND_CLOCK_RATE, "8000");
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.KEEP_AWAKE_IN_CALL, false); // raja
		put(SipConfigManager.INVERT_PROXIMITY_SENSOR, true);
	...
	public String getUserAgent(Context ctx) {
		...
		if(userAgent.equalsIgnoreCase(CustomDistribution.getUserAgent())) {
			...
			if(pinfo != null) {
				...
				userAgent +=  pinfo.versionName+" Beta - "+android.os.Build.DEVICE+"-"+Compatibility.getApiLevel();
			}
		}
		return userAgent;
	}
	...
	public boolean useIntegrateDialer() {
		return false;//getPreferenceBooleanValue(SipConfigManager.INTEGRATE_WITH_DIALER);
	}
