...
public class Sonetel extends SimpleImplementation {
	...
	public void fillLayout(final SipProfile account) {
		...
		accountUsername.getEditText().setInputType(InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS);
	...
	public void setDefaultParams(PreferencesWrapper prefs) {
		...
		prefs.setPreferenceStringValue(SipConfigManager.STUN_SERVER, "stun.sonetel.com");
		prefs.setPreferenceBooleanValue(SipConfigManager.KEEP_ALIVE_USE_WAKE, false);
		...
		prefs.setPreferenceStringValue(SipConfigManager.GSM_INTEGRATION_TYPE,"0");
