...
public abstract class SimpleImplementation extends BaseImplementation {
	...
	//protected CheckBoxPreference accountSignup;
	protected Preference customPref;
	...
	//protected static String SIGNUP = "signup";
	protected static String CUSTOM_PREF = "customPref";
	...
	protected void bindFields() {
		...
		//accountSignup = (CheckBoxPreference) parent.findPreference(SIGNUP);
		customPref = (Preference) parent.findPreference("CUSTOM_PREF");
		
		//accountSignup.setOnPreferenceClickListener(overrider);
	}
	...
	{
		//boolean isNew = true;
		return accountSignup.isChecked();
		//return isNew;
	}*/
