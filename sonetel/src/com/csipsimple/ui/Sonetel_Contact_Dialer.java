...
public class Sonetel_Contact_Dialer extends Activity implements OnClickListener, OnLongClickListener, OnDialKeyListener, TextWatcher {
	...
	// Text dialer
			...
			R.id.switchTextView};*/ //yuva
	private int[] buttonsToAttach = new int[] { R.id.button0, R.id.dialButton, R.id.deleteButton,
		// Text dialer
			R.id.dialTextButton, R.id.deleteTextButton,
			R.id.switchTextView};
...
//	private GestureDetector gestureDetector;
	...
	private void initView() {
		...
		backFlipTextDialerButton.setImageResource(R.drawable.ic_tab_unselected_contacts);
		...
		if(! TextUtils.isEmpty(theme)) {
			new Theme(this, theme, new Theme.onLoadListener() {
				...
				public void onLoad(Theme t) {
					...
					//t.applyBackgroundDrawable(findViewById(R.id.vmButton), "btn_dial_action_left_normal");//yuva
	...
	private void initPaneMode() {
		if(!needDualPaneMode()) {
			...
			digitDialer.setVisibility(View.GONE);
			textDialer.setVisibility(View.GONE);
			sipTextUri.setListVisibility(View.GONE);
			backFlipTextDialerButton.setVisibility(View.GONE);
			backFlipDigitDialerButton.setVisibility(View.GONE);
		}
	}
