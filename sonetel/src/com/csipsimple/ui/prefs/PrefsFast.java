...
//	private RadioButton sntlUsr;
//	private RadioButton nonSntlUsr;
	...
	//	sntlUsr = (RadioButton) findViewById(R.id.sntlUser);
	//	nonSntlUsr = (RadioButton) findViewById(R.id.nonSntlUser);
	...
	//	sntlUsr.setOnClickListener(this);
	//	nonSntlUsr.setOnClickListener(this);
	...
	//	findViewById(R.id.row_SntlUsr).setOnClickListener(this);
	//	findViewById(R.id.row_nonSntlUsr).setOnClickListener(this);
	...
	private void applyPrefs() {
		...
		// About integration
		edt.putBoolean(SipConfigManager.INTEGRATE_WITH_DIALER, integrate); //yuva
		edt.putBoolean(SipConfigManager.INTEGRATE_WITH_DIALER, false);
