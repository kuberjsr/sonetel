...
public class MainPrefs extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prefs_list.add(new PrefGroup(R.string.prefs_network, R.string.prefs_network_desc, 
				R.drawable.ic_prefs_network, new Intent(this, SonetelSettings.class)));
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		//menu.findItem(MENU_EXPERT_VIEW).setTitle(getToogleExpertTitle());yuva
	...
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {//yuva
