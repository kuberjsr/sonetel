...
public class CallHandlerPlugin {
     ...
     */
    public void loadFrom(final String componentName, String number,String actualCall, OnLoadListener l) {
        ...
        it.putExtra(Intent.EXTRA_TEXT, actualCall);
        it.setComponent(cn);
     ...
     * @param l Listener to fire on load completion
     */
    public void loadFrom(final Long accountId, String number, String actualCall,OnLoadListener l) {
        ...
        for (String packageName : callHandlers.keySet()) {
            if (accountId == getAccountIdForCallHandler(context, packageName)) {
                loadFrom(packageName, number,actualCall, l);
                return;
            }
        }
