...
//import com.sonetel.plugins.telephony.CallHandler;
import com.sonetel.utils.AccountListUtils;
import com.sonetel.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        		...
        		telCmp = new ComponentName(getContext(), com.sonetel.plugins.sonetelcallthru.CallThru.class);//CallHandler.class);
        	//else
        		//telCmp = new ComponentName(getContext(), com.sonetel.plugins.sonetelcallback.CallBack.class);//CallHandler.class);
        //}
        //else
    		//telCmp = new ComponentName(getContext(), com.sonetel.plugins.sonetelcallback.CallBack.class);//CallHandler.class);
        // UI management
                    ...
                    do {
                        ...
                        if (accountStatusDisplay.availableForCalls) {
                            BitmapDrawable drawable = new BitmapDrawable(getResources(), 
                                    WizardUtils.getWizardBitmap(getContext(), account));//getWizardBitmap(getContext(), account));
                            quickAction.addItem(drawable, "VoIP",//account.display_name,
                                    new OnClickListener() {
                                        public void onClick(View v) {
                                            setAccount(account);
                                            quickAction.dismiss();
        ...
        if (showExternals) {
            ...
            for (String packageName : callHandlers.keySet()) {
               ...
               // }
                ...
                ch.loadFrom(packageName, null,null, new OnPluginLoadListener());
            }
        }
   ...
   /* public void setAccount(SipProfile aAccount) {
    ...
    public  void setAccount(SipProfile aAccount) {
		...
		if (account == null) {
			textView.setText(getResources().getString(R.string.use_callthru));
			//textView.setText("testing");
			imageView.setImageResource(R.drawable.ic_wizard_sonetel);
			}
		else
		{
  ...
  /*  public SipProfile getSelectedAccount() {
    ...
    public SipProfile getSelectedAccount() {
    	...
    	if(account == null) {
	       ...
	       //     prefsWrapper = new PreferencesWrapper(getContext());
	       // }
	       // calThruNbr = prefsWrapper.getCallthruNumber();
			...
			for(String callHandler : handlers.keySet()) {
		       // if(calThruNbr!=null)
		        //{
		        	//if(!calThruNbr.equalsIgnoreCase(""))
		        	//{
		        		if(callHandler.equalsIgnoreCase("com.sonetel/com.sonetel.plugins.sonetelcallthru.CallThru")) {
		        	...
		        	//else
		        	//{
		        	//	if(callHandler.equalsIgnoreCase("com.sonetel/com.sonetel.plugins.sonetelcallback.CallBack")) {
		        	//		Log.d(THIS_FILE, "Prefer Callback");
		        	//		retAcc.id = -3;//CallHandlerPlugin.getAccountIdForCallHandler(getContext(), callHandler);
		        	//		return retAcc;
		        	//	}
		        	//}
		       // }
