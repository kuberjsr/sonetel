...
import com.sonetel.service.SipNotifications;
...
import com.sonetel.utils.Threading;
...
//			eventLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.sonetel.inEventLock");
...
//		if(ongoingCallLock == null) {
 //           PowerManager pman = (PowerManager) pjService.service.getSystemService(Context.POWER_SERVICE);
  //          ongoingCallLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.sonetel.ongoingCallLock");
//=======
    public void initService(PjSipService srv) {
        pjService = srv;
        notificationManager = pjService.service.notificationManager;
