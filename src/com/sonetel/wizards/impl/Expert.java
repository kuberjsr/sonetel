...
//	private EditTextPreference accountKaInterval;
	...
	public void fillLayout(final SipProfile account) {
		...
		accountAllowContactRewrite.setChecked(false);//Yuva for multiple reg //account.allow_contact_rewrite);
	...
	public SipProfile buildAccount(SipProfile account) {
		...
		account.allow_contact_rewrite = false;//Yuva for multiple reg //accountAllowContactRewrite.isChecked();
