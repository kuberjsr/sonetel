...
import com.sonetel.ui.PickupSipUri;
import com.sonetel.ui.incall.CallProximityManager.ProximityDirector;
import com.sonetel.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.sonetel.utils.CallsUtils;
...
import com.sonetel.utils.keyguard.KeyguardWrapper;
import com.sonetel.widgets.IOnLeftRightChoice;
import com.sonetel.widgets.ScreenLocker;
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.sonetel.videoCall");
