...
package com.sonetel.ui.outgoingcall;
...
import com.sonetel.utils.UriUtils;
...
public class OutgoingCallChooser extends SherlockFragmentActivity {
     ...
     */
    public void connectService(Context aContext) {
    	
    	PreferencesProviderWrapper prefsWrapper = null;
    	int i =0;
    	if(aContext == null)
    	{
    	...
    	{
    		 prefsWrapper = new PreferencesProviderWrapper(aContext);
    		 i=2;
    	}
