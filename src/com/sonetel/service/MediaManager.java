...
import com.sonetel.utils.Ringer;
import com.sonetel.utils.accessibility.AccessibilityWrapper;
import com.sonetel.utils.audio.AudioFocusWrapper;
import com.sonetel.utils.bluetooth.BluetoothWrapper;
import com.sonetel.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.sonetel.onIncomingCall.SCREEN");
