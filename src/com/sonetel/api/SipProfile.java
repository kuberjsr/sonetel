...
import com.sonetel.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
    ...
    public final static Uri ACCESS_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://"
            + SipManager.AUTHORITY + "/" + ACCESS_NUMS_TABLE_NAME);
    /**
    ...
    public final static Uri ACCESS_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://"
            + SipManager.AUTHORITY + "/" + ACCESS_NUMS_TABLE_NAME);
    ...
    public String android_group = "";
   	...
   	public String entid = null;
	public String extension = null;
	public String pin = null;
	public String usrid = null;
	public boolean mobileNoExist;
	public String mobile_nbr = "+";

    
	public static final String FIELD_MOBILE_NBR = "mobile_nbr";
	...
	public static final String FIELD_USRID = "usrid";
    ...
    private SipProfile(Parcel in) {
		...
		entid  = getReadParcelableString(in.readString());
		extension = getReadParcelableString(in.readString());
		pin = getReadParcelableString(in.readString());
		mobile_nbr = getReadParcelableString(in.readString());
		usrid = getReadParcelableString(in.readString());
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(getWriteParcelableString(entid));
        dest.writeString(getWriteParcelableString(extension));
        dest.writeString(getWriteParcelableString(pin));
        dest.writeString(getWriteParcelableString(mobile_nbr));
        dest.writeString(getWriteParcelableString(usrid));
 ...
 tmp_s = args.getAsString(FIELD_ENTID);
        if (tmp_s != null) {
        	entid = tmp_s;
        }
        tmp_s = args.getAsString(FIELD_EXT);
        if (tmp_s != null) {
        	extension = tmp_s;
        }
        tmp_s = args.getAsString(FIELD_PIN);
 if (tmp_s != null) {
        	pin = tmp_s;
        }
        tmp_s = args.getAsString(FIELD_USRID);
        if (tmp_s != null) {
        	usrid = tmp_s;
        }
        tmp_s = args.getAsString(FIELD_MOBILE_NBR);
        if (tmp_s != null) {
        	mobile_nbr = tmp_s;
        }
    ...
    public ContentValues getDbContentValues() {
        ...
        args.put(FIELD_ANDROID_GROUP, android_group);
                args.put(FIELD_ENTID, entid);
        args.put(FIELD_EXT, extension);
        args.put(FIELD_PIN, pin);
        args.put(FIELD_USRID, usrid);
        args.put(FIELD_MOBILE_NBR, mobile_nbr);
